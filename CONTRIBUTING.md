...
- See [Pulsate Specification](https://spec.pulsate.dev) about the Pulsate's model and design.
...
For more information, see the [Prisma documentation](https://www.prisma.io/docs/orm/prisma-migrate/getting-started).
