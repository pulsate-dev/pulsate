...
export class SnowflakeIDGenerator {
  readonly #WORKER_ID_BIT_LENGTH = 10n;
  readonly #INCREMENTAL_BIT_LENGTH = 12n;
  readonly #MAX_WORKER_ID = (1n << this.#WORKER_ID_BIT_LENGTH) - 1n;
  readonly #MAX_INCREMENTAL = (1n << this.#INCREMENTAL_BIT_LENGTH) - 1n;

  readonly #workerID: bigint = 0n;
  #incremental = 0n;
